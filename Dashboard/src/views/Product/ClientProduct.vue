...
<template>
  ...
  <div
    class="rounded-sm border border-stroke bg-white px-5 pt-6 pb-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1"
  >
        ...
        <tbody>
          <tr v-if="!dataProduct">
            ...
            <tr v-else>
              ...
              <td class="py-5 px-4">
                <p class="text-black dark:text-white">{{ dataProduct.csr_key }}</p>
              </td>
              <td class="py-5 px-4">
                <p class="text-black dark:text-white">{{ dataProduct.postman_pem }}</p>
              </td>
              <td class="py-5 px-4">
                <p class="text-black dark:text-white">{{ dataProduct.slot_id }}</p>
              </td>
              <td class="py-5 px-4">
                <p class="text-black dark:text-white">{{ dataProduct.password }}</p>
              </td>
              <td class="py-5 px-4">
                <p class="text-black dark:text-white">{{ dataProduct.finance_key }}</p>
              </td>
              <td class="py-5 px-4">
